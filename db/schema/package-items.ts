...
export const packageItems = sqliteTable('package_items', {
  ...
  equipmentItemId: integer('equipment_item_id').references(() => equipmentItems.id),
  ...
  index('package_item_equipment_item_index').on(table.equipmentItemId),
  index('package_item_inventory_item_index').on(table.inventoryItemId),
