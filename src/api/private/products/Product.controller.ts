...
import { ProductCreateManyRoute, ProductCreateRoute, ProductDeleteRoute, ProductDetailRoute, ProductListRoute, ProductOptionRoute, ProductUpdateRoute } from 'src/api/private/products/Product.route';
